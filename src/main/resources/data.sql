...
--users
INSERT INTO users(username,password,enabled) values('batman','batman',true);
INSERT INTO users(username,password,enabled) values('superman','superman',true);
INSERT INTO users(username,password,enabled) values('catwoman','catwoman',true);
INSERT INTO users(username,password,enabled) values('daredevil','daredevil',true);
INSERT INTO users(username,password,enabled) values('alfred','alfred',true);
INSERT INTO users(username,password,enabled) values('dococ','dococ',true);
INSERT INTO users(username,password,enabled) values('zod','zod',true);
INSERT INTO users(username,password,enabled) values('spiderman','spiderman',true);
INSERT INTO users(username,password,enabled) values('ironman','ironman',true);
INSERT INTO users(username,password,enabled) values('profx','profx',true);

-- authorities
INSERT INTO authorities(username,authority) values('batman','admin');
INSERT INTO authorities(username,authority) values('catwoman','admin');
INSERT INTO authorities(username,authority) values('daredevil','admin');
INSERT INTO authorities(username,authority) values('alfred','admin');
INSERT INTO authorities(username,authority) values('dococ','admin');
INSERT INTO authorities(username,authority) values('zod','admin');
INSERT INTO authorities(username,authority) values('spiderman','admin');
INSERT INTO authorities(username,authority) values('ironman','admin');
INSERT INTO authorities(username,authority) values('profx','admin');
INSERT INTO authorities(username,authority) values('superman','superadmin');
